...
export default function Footer({ children }) {
  return (
    <>
      <footer className="px-3 py-4 bg-white dark:bg-gray-800 text-2 text-gray-500 dark:text-gray-200 transition-colors duration-200 bottom-0 w-full">
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-4 md:mt-0 flex flex-col md:flex-row">
            ...
            <div className="mt-4 md:mt-0 flex-1 flex items-center justify-center md:border-r border-gray-100">
              <a className="hover:text-primary-gray-20" href="https://github.com/MichaelLeonffu/Cookie-and-Rock">
            ...
            <div className="mt-7 md:mt-0 flex-1 flex flex-col items-center justify-center md:items-start md:pl-5">
              ...
              <span className="mt-7 md:mt-1">
                Created by&nbsp;
                    <a className="underline hover:text-primary-gray-20" href="https://www.linkedin.com/in/michael-leonffu/">
                  Michael Leonffu
                    </a>
              </span>
              <span className="mt-7 md:mt-1">
                Logo Art by&nbsp;
                    <a className="underline hover:text-primary-gray-20" href="https://www.linkedin.com/in/annawli99/">
                  Anna Li
                    </a>
              </span>
            </div>
