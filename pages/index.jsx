    ...
    <div>
      ...
      {/* <div class="container mx-auto px-4">  
        ...
        <div class="px-4 py-6 sm:px-0">
          ...
          <div class="border-4 border-dashed border-gray-200 rounded-lg h-96">
            <a class="object-cover border-4 border-gray-500 rounded-lg h-96 px-4 py-6">inside</a>
          </div>
        </div>
      </div> */}
      ...
      {/* <div class="p-6 max-w-sm mx-auto bg-white rounded-xl shadow-md flex items-center space-x-4">
        <div class="flex-shrink-0">
          <img class="h-12 w-12" src="/sky.png" alt="ChitChat Logo"></img>
        </div>
        <div>
          <div class="text-xl font-medium text-black">Woohoo Lets go</div>
          <p class="text-gray-500">Broken!!!</p>
        </div>
      </div> */}
      {/* Keep the existing code here */}
      {/* <Image src="/sky.png" alt="me" width="64" height="64" />

      <iframe width="546" height="495" seamless frameBorder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRSToPVTBfq23-CfqWsv9OYCPvl96SFy1SvFnnni-59CooMkYZsTIzozyubJeGgIt_ESYP3BvmbsnMY/pubchart?oid=413877478&amp;format=interactive"></iframe>

      <video width="320" height="240" controls>
        <source src="/black_ball.mov" type="video/mp4"></source>
      </video> */}

      <div className="bg-indigo-600">
        <p class="ml-3 font-medium text-white truncate text-center">Fix me!</p>
      </div>
      ...
      <div className="container mx-auto bg-yellow-300">
        {/* <div className="border border-black bg-purple-600"> */}
        <h2 className="text-lg text-center" >Blog</h2>

        <div className="mx-auto max-w-4xl grid grid-cols-1 md:grid-cols-3 md:gap-4 md:p-4">
          {allPostsData.map(({ id, title, series, author, date, description }) => (

            <div className="md:max-w-md bg-white md:rounded-xl shadow-md overflow-hidden">
              {/* <div className="flex"> */}
              <div className="flex-shrink-0">
                <img className="h-48 w-full object-cover" src="/meow.png" alt="Man looking at item at a store" />
              </div>
              <div className="p-8">
                <div className="uppercase tracking-wide text-sm text-indigo-500 font-semibold">{title}</div>
                <a href={"posts/" + id} className="block mt-1 text-lg leading-tight font-medium text-black hover:underline">{series}</a>
